...
class ControllerPaymentBankorder extends Controller {
	protected function index() {
		...
		$xml .= '	<description>' . "#" . $this->session->data['order_id'] . ' ' . $this->config->get('config_name') . ' ' . $order_info['payment_firstname'] . ' ' . $order_info['payment_address_1'] . ' ' . $order_info['payment_address_2'] . ' ' . $order_info['payment_city'] . ' ' . $order_info['email'] . '</description>';
